...
class DeactivateSubController extends Controller
{
    ...
    public function index(){
        if(!Permission::check('deactivate', 'true'))
        {
        ...
        ->paginate(10);
        return view('deactivate_sub.index', $customerInfo);
    }
  
    public function DeactivateSub(Request $request){
        ...
        for($i=1;$i<count($cust_info[0]) ; $i++){
            ...
            $this->NGBSSService->DeactivateSub($number);
        }
